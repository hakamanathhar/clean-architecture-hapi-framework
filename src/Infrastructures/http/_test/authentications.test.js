...
const AuthenticationTokenManager = require('../../../Applications/security/AuthTokenManager');
...
describe('/authentications endpoint', () => {
  ...
  describe('when PUT /authentications', () => {
    ...
    it('should return 400 if refresh token not registered in database', async () => {
      // Arrange
      const server = await createServer(container);
      const refreshToken = await container.getInstance(AuthenticationTokenManager.name).createRefreshToken({ username: 'hakaman' });
